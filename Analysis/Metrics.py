...
def CalculateRecallPrecisionFScoreAndSupport(comparisons, goldStandardPosition='first'):
    """
    ...
    return precision_recall_fscore_support(goldStandardResults, testGroupResults, average='binary')
